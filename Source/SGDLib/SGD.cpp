                                      ...
                                      IDataReader* validationSetDataReader)
{
    ...
    for (auto nodeIter = learnableNodes.begin(); nodeIter != learnableNodes.end(); nodeIter++)
    {
        ...
        {
            nodesToUpdateDescriptions.push_back(node->NodeDescription() + L" : [" + Microsoft::MSR::CNTK::ToWString(string(node->GetSampleLayout()), false) + L"]");
...
SGDParams::SGDParams(const ConfigRecordType& configSGD, size_t sizeofElemType)
{
    ...
    m_tensorBoardLogDir = configSGD(L"tensorBoardLogDir", L"");
