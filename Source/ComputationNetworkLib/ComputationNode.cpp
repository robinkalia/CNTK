    ...
    WriteFormattingOptions()
{
    ...
    if (config.Exists(L"format"))
    {
        ...
        sequenceSeparator = Microsoft::MSR::CNTK::ToLegacyString(Microsoft::MSR::CNTK::ToUTF8(formatConfig(L"sequenceSeparator", Microsoft::MSR::CNTK::ToWString(sequenceSeparator, false))));
        sequencePrologue  = Microsoft::MSR::CNTK::ToLegacyString(Microsoft::MSR::CNTK::ToUTF8(formatConfig(L"sequencePrologue",  Microsoft::MSR::CNTK::ToWString(sequencePrologue, false))));
        sequenceEpilogue  = Microsoft::MSR::CNTK::ToLegacyString(Microsoft::MSR::CNTK::ToUTF8(formatConfig(L"sequenceEpilogue",  Microsoft::MSR::CNTK::ToWString(sequenceEpilogue, false))));
        elementSeparator  = Microsoft::MSR::CNTK::ToLegacyString(Microsoft::MSR::CNTK::ToUTF8(formatConfig(L"elementSeparator",  Microsoft::MSR::CNTK::ToWString(elementSeparator, false))));
        sampleSeparator   = Microsoft::MSR::CNTK::ToLegacyString(Microsoft::MSR::CNTK::ToUTF8(formatConfig(L"sampleSeparator",   Microsoft::MSR::CNTK::ToWString(sampleSeparator, false))));
        precisionFormat   = Microsoft::MSR::CNTK::ToLegacyString(Microsoft::MSR::CNTK::ToUTF8(formatConfig(L"precisionFormat",   Microsoft::MSR::CNTK::ToWString(precisionFormat, false))));
