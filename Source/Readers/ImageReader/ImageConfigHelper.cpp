    ...
    : m_dataFormat(CHW)
{
    ...
    features.m_id = 0;
    features.m_name = Microsoft::MSR::CNTK::ToFixedWString(featureSection.ConfigName(), false);
    ...
    labelSection.m_id = 1;
    labelSection.m_name = Microsoft::MSR::CNTK::ToFixedWString(label.ConfigName(), false);
