...
namespace CNTK
{
    ...
    proto::Axis* Serializer::CreateProto(const Axis& src, Arena* arena)
    {
        ...
        dst->set_name(Microsoft::MSR::CNTK::ToString(src.Name()));
    ...
    Axis* Serializer::CreateFromProto(const proto::Axis& src)
    {
        ...
        {
            return new Axis(Microsoft::MSR::CNTK::ToWString(src.name()), src.is_ordered_dynamic_axis());
        }
    }
    ...
    proto::Dictionary* Serializer::CreateProto(const Dictionary& src, Arena* arena)
    {
        ...
        {
            Copy(kv.second, dst->mutable_data()->operator[](Microsoft::MSR::CNTK::ToString(kv.first)), arena);
        }
        return dst;
    }
    ...
    Dictionary* Serializer::CreateFromProto(const proto::Dictionary& src)
    {
        ...
        {
            Copy(kv.second, dst->operator[](Microsoft::MSR::CNTK::ToWString(kv.first)));
        }
        return dst;
    }
    ...
    void Serializer::Copy(const DictionaryValue& src, proto::DictionaryValue& dst, Arena* arena)
    {
        ...
        case DictionaryValue::Type::String:
            dst.set_string_value(Microsoft::MSR::CNTK::ToString(src.Value<std::wstring>()));
            break;
    ...
    void Serializer::Copy(const proto::Dictionary& src, Dictionary& dst)
    {
        ...
        for (const auto& kv : src.data())
        {
            Serializer::Copy(kv.second, dst[Microsoft::MSR::CNTK::ToWString(kv.first)]);
        }
    }
    ...
    void Serializer::Copy(const proto::DictionaryValue& src, DictionaryValue& dst)
    {
        ...
        case proto::DictionaryValue::String:
            dst.m_data.m_ptr = new std::wstring(Microsoft::MSR::CNTK::ToWString(src.string_value()));
            break;
